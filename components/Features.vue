  ...
  <div class="bg-white py-16 sm:py-20">
    <div class="mx-auto max-w-7xl px-6 lg:px-8">
      <div class="mx-auto max-w-2xl lg:text-center">
        <h2 class="text-base font-semibold leading-7 text-green-800">{{ featuresTitle }}</h2>
        ...
        <dl class="grid max-w-xl grid-cols-1 gap-x-8 gap-y-10 lg:max-w-none lg:grid-cols-2 lg:gap-y-16">
          <div v-for="feature in features" :key="feature.name" class="relative pl-16">
            <dt class="text-base font-semibold leading-7 text-gray-900">
              <div class="absolute left-0 top-0 flex h-10 w-10 items-center justify-center rounded-lg bg-green-500">
...
import { ArrowPathIcon, UserGroupIcon, LockClosedIcon, DocumentCheckIcon, WrenchScrewdriverIcon, TruckIcon, BanknotesIcon, ShieldCheckIcon, ClipboardDocumentCheckIcon } from '@heroicons/vue/24/outline';
...
const iconMap = {
  ...
  'WrenchScrewdriverIcon': WrenchScrewdriverIcon, // Venta de Recambios
  'TruckIcon': TruckIcon,                         // Recogida de Vehículos
  'BanknotesIcon': BanknotesIcon,                 // Tasación y Compra
  'ShieldCheckIcon': ShieldCheckIcon,             // Garantía / Verificación
  'ClipboardDocumentCheckIcon': ClipboardDocumentCheckIcon // Alternativa DGT
};
