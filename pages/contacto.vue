    ...
    <section class="bg-white dark:bg-gray-900">
      <div class="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
        ...
        <form class="space-y-8" @submit.prevent="enviarFormulario">
          ...
          <button type="submit" class="py-3 px-5 text-sm font-medium text-center text-white rounded-lg bg-green-600 w-full hover:bg-green-700 focus:ring-4 focus:outline-none focus:ring-green-300 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">Enviar Mensaje</button>
        </form>
      </div>
    </section>
